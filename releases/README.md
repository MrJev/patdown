...
6. The GitHub workflow checks the tag against the CLI version, renders the matching notes into the release body, and publishes `patdown`, `@patdown/rules`, `@patdown/jev`, and `@patdown/pi` to npm.
